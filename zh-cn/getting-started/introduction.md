...
- 编译体积：运行时体积非常小（约 8~20 KB，gzip：5~11 KB），并支持高度的 [Tree-Shaking](https://developer.mozilla.org/zh-CN/docs/Glossary/Tree_shaking) 优化。同时，编译器对输出文件体积也做了深度优化，最终编译结果仅为其他框架的 20% 到 50%；
